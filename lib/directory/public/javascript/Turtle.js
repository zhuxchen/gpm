 ...
 *  Date: 2014/6/23
 */
define('model',["ajax", "Storage"], function (cAjax, Storage) {
...
define("Turtle", (function (global) {
    return function () {
        return global.Turtle;
    }
}(this)));
...
define('UIMask',['Widget'], function (Widget) {
...
define('UILayer',['Widget', 'UIMask'], function (Widget, UIMask) {
...
define('UIToast',['UILayer'], function (UILayer) {
...
define('BaseView',['HeaderView', 'Storage','UIToast'], function (HeaderView, Storage, UIToast) {
